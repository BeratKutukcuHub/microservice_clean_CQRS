...
namespace AbstractionBlocks.CommonInfrastructure.Logger
{
    public class LoggerService<TLogCategory> :
    AbstractBlocks.CommonDomain.Logger.ILoggerService<TLogCategory> where TLogCategory : class
    {
        ...
        public void Error(string message, Exception ex, Guid id, Guid? correlationId = null)
